...
import signal
import numpy as np
from redes_neuronales import Red, Capa, leer1, NeuronaPerceptron, NeuronaEntrada
...
def main():
    parser = argparse.ArgumentParser(description="Perceptron - Problema Real 1")
    ...
    parser.add_argument("--umbral", type=float, default=0.2)
